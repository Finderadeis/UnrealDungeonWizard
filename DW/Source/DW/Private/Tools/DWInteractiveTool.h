...
#include "DWInteractiveTool.generated.h"


/**
 * Builder for UDWInteractiveTool
 */
UCLASS()
class DW_API UDWInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UDWInteractiveTool
 */
UCLASS(Transient)
class DW_API UDWInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UDWInteractiveToolProperties();
...
/**
 * UDWInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class DW_API UDWInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UDWInteractiveToolProperties> Properties;
