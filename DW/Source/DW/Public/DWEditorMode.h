...
#include "DWEditorMode.generated.h"
 ...
 */
UCLASS()
class UDWEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_DWEditorModeId;

	static FString BaseToolName;

	UDWEditorMode();
	virtual ~UDWEditorMode();
